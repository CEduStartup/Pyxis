...
class BaseBootstrapForm(object):
    # deprecated in 1.3?
    #__metaclass__ = DeclarativeFieldsMetaclass
    
    def __init__(self, data=None, files=None, auto_id='id_%s', prefix=None, initial=None):

        super(BaseBootstrapForm, self).__init__(data, files, auto_id, prefix, initial)
...
class BootstrapForm(BaseBootstrapForm, forms.Form): pass

class BootstrapModelForm(BaseBootstrapForm, forms.ModelForm): pass
